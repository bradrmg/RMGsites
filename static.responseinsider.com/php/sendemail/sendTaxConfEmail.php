...
if(($tourcode != "") && ($_REQUEST['Email'] != "") && ($_REQUEST['lead_type'] != "")){
	...
	$uid = $_REQUEST['TourCode'] . '~' . $todayTimeStamp . '~Tax';
	if(!mssql_num_rows($queryemail)){
		...
		if(!mssql_num_rows($query)){
			...
			$vars .= "&uid=" . $uid . "~tax";
			$returnRslt = post_content("realestateeventregistration.a-rmgws01.blooint.com/script/sendemail/taxlien/sendTaxConfEmail.php", count($result), $vars);
