...
if(($tourcode != "") && ($_REQUEST['Email'] != "") && ($_REQUEST['lead_type'] != "")){
	...
	$uid = $_REQUEST['TourCode'] . '~' . $todayTimeStamp;
	if(!mssql_num_rows($queryemail)){
		...
		if(!mssql_num_rows($query)){
			...
			$vars .= "&uid=" . $uid;
			$returnRslt = post_content("realestateeventregistration.a-rmgws01.blooint.com/script/sendConfEmail.php", count($result), $vars);
